...
def create_sliding_windows(df: pd.DataFrame, window_size: int = 20) -> np.ndarray:
    ...
    windows = sliding_window_view(features, (window_size, features.shape[1])).squeeze(axis=1)
